...
pyflow validate workflows/<name>.yaml
...
Check:
1. Is the tool name spelled correctly? Available: `http_request`, `transform`, `condition`, `alert`, `storage` (plus any custom tools)
...
└── Not sure which stage?
    └── Run: pyflow validate workflows/<name>.yaml
